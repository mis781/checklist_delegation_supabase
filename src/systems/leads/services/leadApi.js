        ...
        const result = (readyLeads || [])
            ...
            .map(lead => {
                ...
                return {
                    ...
                    created_at: lead.created_at,
                    rawCreatedAt: lead.created_at,
                    makeQuotationAt: latestFollowup.created_at || latestFollowup.followup_date || lead.updated_at || lead.created_at,
                    latestFollowupDate: latestFollowup.followup_date || latestFollowup.created_at,
    ...
    try {
        ...
        const entries = (quotationsData || []).map(q => {
            ...
            return {
                ...
                gst: q.gst || "",
                gstNumber: latestUpdate?.gst_number || q.gst || "",
                gstin: latestUpdate?.gst_number || q.gst || "",
                created_at: q.created_at,
                createdAt: q.created_at,
                quotation_at: q.quotation_at,
                quotationDateRaw: q.quotation_at || q.created_at,
                ...
                nextFollowupDateTime: latestUpdate?.next_followup_at || "",
...
export const submitAdvancePaymentUpdate = async (quotationNo, updateData) => {
    ...
    try {
        ...
        const payload = {
            ...
            gst_number: updateData.gstNumber || quoteMatch.gst || null,
