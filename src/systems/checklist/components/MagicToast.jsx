        ...
        switch (type) {
            case 'success':
                return {
                    ...
                    shadow: 'shadow-emerald-200/50 dark:shadow-black/40',
                    title: 'Success'
                };
            case 'error':
                return {
                    ...
                    accent: 'bg-rose-500',
                    shadow: 'shadow-rose-200/50 dark:shadow-black/40',
                    title: 'Action Failed'
                };
            case 'warning':
                return {
                    ...
                    accent: 'bg-amber-500',
                    shadow: 'shadow-amber-200/50 dark:shadow-black/40',
                    title: 'Warning'
                };
            case 'whatsapp':
            case 'feature_disabled':
                return {
                    icon: <Sparkles className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-pulse" />,
                    bg: 'bg-gradient-to-br from-indigo-50/95 via-purple-50/95 to-pink-50/90 dark:from-slate-900/95 dark:to-indigo-950/40',
                    border: 'border-indigo-150 dark:border-indigo-500/20',
                    accent: 'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500',
                    shadow: 'shadow-indigo-200/40 dark:shadow-black/40',
                    title: 'Coming Soon'
                };
            default:
                return {
                    icon: <Info className="w-6 h-6 text-sky-500" />,
                    bg: 'bg-sky-50/90 dark:bg-slate-900/95',
                    border: 'border-sky-200 dark:border-sky-500/20',
                    accent: 'bg-sky-500',
                    shadow: 'shadow-sky-200/50 dark:shadow-black/40',
                    title: 'Information'
                };
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex p-4 items-start gap-4">
                <div className={`p-2 rounded-xl bg-[#ffffff] dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 shadow-sm flex-shrink-0`}>
                    {config.icon}
                </div>
                ...
                <button
                    onClick={handleClose}
                    className="p-1 hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-colors text-gray-400 hover:text-gray-600"
                >
