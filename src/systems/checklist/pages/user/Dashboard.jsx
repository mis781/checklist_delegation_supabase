            ...
            <div className="card-body">
              <div className="h-[350px] w-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-md">
                <p className="text-gray-500 dark:text-gray-400">
                  Task completion chart would be displayed here
                </p>
              </div>
            </div>
          </div>
...
const TasksList = ({ filter }) => {
  const tasks = [
    ...
    },
    {
      ...
      description:
        "Update the inventory records with the latest stock information",
      dueDate: "2023-05-18",
      frequency: "daily",
      completed: false,
    },
    ...
    <div className="space-y-4">
      {filteredTasks.length === 0 ? (
        ...
        filteredTasks.map((task) => (
          ...
          >
            <div className="p-4 pb-2 bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-950 dark:to-blue-950 border-b border-blue-200 dark:border-blue-800">
