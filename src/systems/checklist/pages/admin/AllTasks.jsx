              ...
              <div className="flex flex-wrap items-center gap-2 flex-grow justify-end">
                <div className="relative flex-grow max-w-sm">
                  ...
                  <input
                    type="text"
                    placeholder={
                      showHistory ? "Search history..." : "Search..."
                    }
                    value={searchTerm}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-1.5 text-xs font-bold rounded-xl border transition-all shadow-sm ${userFilter !== "all" ? "bg-blue-600 text-white border-blue-600" : "bg-white text-gray-600 border-gray-200"}`}
                    >
                      ...
                      <ChevronDown
                        size={14}
                        className={`transition-transform ${dropdownOpen?.userFilter ? "rotate-180" : ""}`}
                      />
                    </button>
                    {dropdownOpen?.userFilter && (
                      <div className="absolute z-50 mt-2 w-48 right-0 rounded-xl bg-white shadow-xl border border-gray-100 py-1 overflow-y-auto max-h-60 animate-in fade-in slide-in-from-top-2 duration-200">
                        <button
                          ...
                          className={`block w-full text-left px-4 py-2 text-xs font-bold transition-colors ${userFilter === "all" ? "bg-blue-50 text-blue-700 border-l-2 border-blue-500" : "text-gray-600 hover:bg-gray-50"}`}
                        >
                          All Users
                        </button>
                        {allUsers.map((name) => (
                    ...
                    <>
                      <div className="relative">
                        ...
                        >
                          ...
                          <ChevronDown
                            size={14}
                            className={`transition-transform ${dropdownOpen?.dateFilter ? "rotate-180" : ""}`}
                          />
                        </button>
                    ...
                    <thead className="bg-gray-50 sticky top-0 z-20 shadow-sm transition-all duration-300">
                      <tr>
                        ...
                        {tableHeaders.map((header) => (
                          <th
                            key={header.id}
                            className={`px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap ${header.id === "status" ? "min-w-[145px]" : ""}`}
                          >
                            {header.label}
                          </th>
                        ))}
                                  ...
                                  <>
                                    {!showHistory ? (
                                      <>
                                        ...
                                        <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm text-gray-800 font-bold">
                                          {task.id}
                                        </td>
