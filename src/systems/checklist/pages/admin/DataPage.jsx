          ...
          <div className="space-y-6">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <h1 className="text-2xl font-bold tracking-tight text-blue-700">
                {formatCategoryName(category)} Data
              </h1>
            </div>
            ...
            <div className="rounded-lg border border-blue-200 shadow-md bg-white">
              <div className="bg-gradient-to-r from-blue-50 to-pink-50 border-b border-blue-100 p-4">
                <h2 className="text-blue-700 font-medium">
                  {formatCategoryName(category)} Information
                </h2>
                <p className="text-blue-600 text-sm">
                  View and manage {formatCategoryName(category).toLowerCase()}{" "}
                  data
                </p>
              </div>
              <div className="p-6">
                <div className="text-center py-12">
                  <p className="text-gray-500">
                    {formatCategoryName(category)} data module is under
                    development.
                  </p>
                  <p className="text-gray-400 mt-2">
                    This section will display{" "}
                    {formatCategoryName(category).toLowerCase()} specific
