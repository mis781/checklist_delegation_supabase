        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-100 dark:border-slate-800/80 pb-8">
          <div>
            <div className="flex items-center gap-4 mb-3">
              <div className="w-12 h-12 bg-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-200 dark:shadow-purple-600/30">
            ...
            <div className="flex items-center gap-3">
              <p className="text-gray-500 dark:text-slate-400 font-bold text-sm tracking-tight">System announcements and priority alerts</p>
          ...
          <div className="flex items-center gap-4">
             {isAdmin && (
              <button
                ...
                className="group flex items-center justify-center gap-2 bg-gray-900 dark:bg-purple-600 hover:bg-purple-600 dark:hover:bg-purple-500 text-white px-8 py-4 rounded-2xl font-bold transition-all active:scale-95 shadow-xl shadow-gray-200 hover:shadow-purple-200 dark:shadow-purple-600/40 dark:hover:shadow-purple-500/60"
              >
